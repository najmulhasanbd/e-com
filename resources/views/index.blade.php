    ...
    "loop": true
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="overflow-hidden position-relative h-100">
                    <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                        <img loading="lazy"
                            src="{{ asset('frontend') }}/assets/images/home/demo3/slideshow-character1.png"
            ...
            <div class="swiper-slide">
                <div class="overflow-hidden position-relative h-100">
                    <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                        <img loading="lazy" src="{{ asset('frontend') }}/assets/images/slideshow-character1.png"
            ...
            <div class="swiper-slide">
                <div class="overflow-hidden position-relative h-100">
                    <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                        <img loading="lazy" src="{{ asset('frontend') }}/assets/images/slideshow-character2.png"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_1.png"
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_2.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_3.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_4.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_5.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_6.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_7.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                        ...
                        <div class="swiper-slide">
                            <img loading="lazy" class="w-100 h-auto mb-3"
                                src="{{ asset('frontend') }}/assets/images/home/demo3/category_8.png"
                                width="124" height="124" alt="" />
                            <div class="text-center">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="details.html">
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-0-1.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img" />
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-0-2.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                ...
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="details.html">
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-1-1.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img" />
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-1-2.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img pc__img-second" />
                                        </a>
                                    </div>
                                ...
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="details.html">
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-2-1.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img" />
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-2-2.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img pc__img-second" />
                                        </a>
                                    </div>
                                ...
                                <div class="swiper-slide product-card product-card_style3">
                                    <div class="pc__img-wrapper">
                                        <a href="details.html">
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-3-1.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img" />
                                            <img loading="lazy"
                                                src="{{ asset('frontend') }}/assets/images/home/demo3/product-3-2.jpg"
                                                width="258" height="313" alt="Cropped Faux leather Jacket"
                                                class="pc__img pc__img-second" />
                                        </a>
                                    </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-4.jpg"
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-5.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                        </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-6.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-7.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-8.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                        </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-9.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                        </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-10.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                        </div>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <a href="details.html">
                                <img loading="lazy"
                                    src="{{ asset('frontend') }}/assets/images/home/demo3/product-11.jpg"
                                    width="330" height="400" alt="Cropped Faux leather Jacket"
                                    class="pc__img" />
                            </a>
                        </div>
